...
newCSharpFile.write("namespace vine.app.message \n")
newCSharpFile.write("{\n")
...
newJavaFile.write("package vine.app.message;\n")
newJavaFile.write("//Auto Generate File, Do NOT Modify!!!!!!!!!!!!!!!\n")
newJavaFile.write("import vine.core.net.HOpCode;\n")
...
for filename in os.listdir("./protofiles"):
	...
	for line in lines:
		...
		if line.find('@module=') != -1 and line.find('StartIndex=') != -1 and line.find('classname=') != -1:
			...
			break		
	#-----循环生成------
	generateOpCode(lines,start_index)
